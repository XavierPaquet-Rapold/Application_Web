        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              req.appendTemplatePath(_templateObject5$6(), mapped.locationId, mapped.paymentId);
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            case 0:
              ...
              req.query('status', mapped.status);
              req.query('batch_token', mapped.batchToken);
              req.appendTemplatePath(_templateObject8$2(), mapped.locationId);
...
var USER_AGENT = 'Square-TypeScript-SDK/9.1.0';
